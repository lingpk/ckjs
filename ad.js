var sjdb_img_all = "https://dzimg.cn/images/2020/07/16/2020071611381740.gif";
var sjdb_img_all_jsifr = "";
var sjdb_link_all = "";

var sjdb_adwidth = 640;
var sjdb_adheight = 120;
var sjdb_sysurl = "//js.dazibenwm.com/";

var mysplit = sjdb_img_all.split(',');
var adtotal = mysplit.length;
var currshow = 1 % adtotal;
var sjdb_imgpath = mysplit[currshow];

mysplit = sjdb_link_all.split(',');
adtotal = mysplit.length;
currshow =(1 % adtotal);
var sjdb_adurl = "https://www.i5qs.com/?ckflv=123";

var sjdb_id=Math.floor(Math.random()*10000);
...
//关闭按钮
sjdb_str+='<img id="sjdb_closeimg_' + sjdb_id + '" onclick="sjdb_close(this)" src="//js.dazibenwm.com/images/adclose.gif" alt="关闭" style="cursor:hand;position:absolute;right:20px;top:20px;z-index:2147483647;visibility:visible;">';

//联盟Logo
sjdb_str+='<a href="' + sjdb_sysurl + '?userid=1" target="_blank"><img  onMouseOver=\'sjdb_largelogo(this)\' onMouseOut=\'sjdb_smalllogo(this)\'  src="' + sjdb_sysurl + 'images/adlogo_small.png" style="cursor:hand;position:absolute;right:0px;bottom:0px;z-index:2147483647;border:0px;visibility:visible;width:27px;height:18px;"></a>';
...
if(sjdb_img_all_jsifr.length>0){
	...
	if(sjdb_imgpath.toLowerCase().indexOf('.swf')>0){
		 sjdb_str+='<div style="position: absolute;top:0px;left:0px;margin:0px;padding:0px;z-index:2147483646;"><a href="' + sjdb_adurl + '" target="_blank" onClick=\'sjdb_click(this)\'><img src="' + sjdb_sysurl + 'images/space.gif" border=0 width="' + screen.availWidth + '" height="' + sjdb_adheight + '" id="sjdb_img_'+sjdb_id+'"></a></div>';
...
var cfposi = "";
if(cfua.indexOf('baiduboxapp')>-1){cfposi="position:absolute;";}else{cfposi="position:fixed;bottom:0px;";}

sjdb_div.style.cssText = cfposi+"z-index:2147483647;left:"+sjdb_leftpx+";width:"+sjdb_divwidth+";text-align:center;";
...
var myTimer = function (callback) {
  ...
  setInterval(function () {
	  if(cfst>(document.body.scrollTop || document.documentElement.scrollTop)){//变小时
		  sjdb_div.style.top = cfst + sjdb_h - sjdb_div.offsetHeight -50+ 'px';
	  }
	  else if(cfst<(document.body.scrollTop || document.documentElement.scrollTop)){//变大时
		  sjdb_div.style.top = cfst + sjdb_h - sjdb_div.offsetHeight+ 'px';
	  }
...
if (cfua.indexOf('baiduboxapp')>-1){myTimer(function (val){});}
